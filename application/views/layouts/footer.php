			...
			<div class="footer_content">
				<div class="row">
					...
					<div class="col-lg-3 footer_col">
						...
						<p class="footer_about_text">Brindar a los alumnos una propuesta educativa basada en la formación integral del alumno a distancia, apoyado de profesores certificados en su disciplina; para el cumplimiento de su objetivo educativo.</p>
					...
					<div class="col-lg-3 footer_col">
						...
						<div class="footer_column_content">
							<ul>
								...
								<li class="footer_list_item"><a href="http://redsocial.educacionintegral.net/">Comunidad</a></>
						...
						<div class="footer_column_content">
							<ul>
								...
								<li class="footer_contact_item">
									...
									</div>info@educacionintegral.net
								</li>
							</ul>
						</div>
					</div>
			...
			<div class="footer_bar d-flex flex-column flex-sm-row align-items-center">
				<div class="footer_copyright">
					<span>
						...
						</script> All rights reserved  by <a href="http://sarkoceles.mx/" target="_blank">sarkoceles</a>
