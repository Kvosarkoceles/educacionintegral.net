...
/**
 * Strings for component 'block_panopto', language 'es_mx', branch 'MOODLE_39_STABLE'
 *
...
$string['block_panopto_async_tasks_desc'] = 'Habilite esta opción para permitir que los trabajos de  inscripción, des-inscripción (dar de baja), y eliminar usuario sucedan asincrónicamente (podría tener un breve retraso antes de ejecutarse)';
...
$string['completed_recordings'] = 'Grabaciones Cmpletadas';
$string['course'] = 'Curso';
...
$string['download_recorder'] = 'Descargar Grabador';
...
$string['provision_error'] = 'Error al provisionar curso.';
