...
/**
 * Strings for component 'tool_dataprivacy', language 'es_mx', branch 'MOODLE_39_STABLE'
 *
...
$string['approvedrequestsubmitted'] = 'Su solicitud ha sido  enviada y será procesada pronto.';
$string['approverequest'] = 'Aprobar solicitud';
$string['automaticdatadeletionapproval'] = 'Aprobación de solicitud de eliminación de datos';
$string['automaticdatadeletionapproval_desc'] = 'Si se habilita, las solicitudes de eliminación de datos son aprobadas automáticamente.<br/>Tenga en cuenta que la aprobación automática solamente aplicará para nuevas solicitudes de eliminación de datos con esta configuración habilitada. Las solicitudes existentes de eliminación de datos pendientes de aprobación todavía tendrán que ser aprobadas manualmente por el oficial de privacidad..';
$string['automaticdataexportapproval'] = 'Aprobación de solicitud de exportación automática de datos';
$string['automaticdataexportapproval_desc'] = 'Si se habilita, las solicitudes de exportación de datos son aprobadas automáticamente.<br/>Tenga en cuenta que la exportación automática solamente aplicará para nuevas solicitudes de exportación de datos con esta configuración habilitada. Las solicitudes existentes de exportación de datos pendientes de aprobación todavía tendrán que ser aprobadas manualmente por el oficial de privacidad..';
...
$string['categorydefault_help'] = 'La categoría por defecto es la categoría de datos aplicada a cualquier nueva instancia. Si Heredar es seleccionado, la categoría de datos de un contexto superior es aplicada. Los contextos son (de bajo a alto): Bloques > Módulos de actividad > Cursos > Categorías de curso > Usuario > Sitio.';
$string['category_help'] = 'Una categoría en el registro de datos describe un tipo de datos. Puede añadirse una nueva categoría, o si Heredar es seleccionado, la categoría de datos de un contexto superior es aplicada. Los contextos son (de bajo a alto): Bloques > Módulos de actividad > Cursos > Categorías de curso > Usuario > Sitio.';
...
$string['confirmcontextdeletion'] = '¿Realmente desea confirmar la eliminación de los contextos seleccionados? Esto también eliminará todos los datos del usuario para sus respectivos sub-contextos.';
$string['confirmdenial'] = '¿Realmente desea denegar esta solicitud de datos?';
$string['confirmrequestresubmit'] = '¿Está Usted seguro de querer eliminar la actual solicitud  {$a->type} para {$a->username} y re-enviarla?';
...
$string['createdeletedatarequest'] = 'Crear solicitud de eliminación de datos';
...
$string['datadeletionpagehelp'] = 'Datos para los cuales el período de retención ha expirado están listados aquí. Por favor revise y confirme la eliminación de datos, la que entonces será ejecutada por el trabajo agendado "Eliminar contextos que han expirado".';
$string['dataprivacy:downloadallrequests'] = 'Descargar datos exportados para todos';
$string['dataprivacy:downloadownrequest'] = 'Descargar sus propios datos exportados';
...
$string['dataprivacy:requestdelete'] = 'Solicitar eliminación de datos para Usted mismo';
$string['dataprivacy:requestdeleteforotheruser'] = 'Solicitar eliminación de datos a nombre y en representación de otro usuario';
...
$string['datarequestcreatedfromscheduledtask'] = 'Creado automáticamente desde un trabajo agendado (usuario pre-existente eliminado ).';
...
$string['dataretentionexplanation'] = 'Este resumen muestra los propósitos y las categorías por defecto para retener datos del usuario. Ciertas áreas pudieran tener propósitos y categorías más específicas que las aquí enlistadas.';
...
$string['defaultexpiredexcept'] = 'Datos para todos los usuarios, excepto aquellos que tengan cualquiera de los siguientes roles:<br>
{$a->unexpired}';
...
$string['deleteexistingdeleteduserstask'] = 'Crear solicitud de eliminación de datos para usuarios eliminados pre-existentes';
...
$string['deprecatedexplanation'] = 'Este plugin está usando una versión antigua de alguna de las interfazes de privacidad y debería de ser actualizado.';
...
$string['dporolemapping_desc'] = 'El Oficial de Privacidad puede gestionar las solicitudes de datos. La capacidad tool/dataprivacy:managedatarequests debe de estar permitida para que un rol sea enlistado como una opción para mapeo como Oficial de Privacidad.';
...
$string['exceptionnotificationbody'] = '<p>Ocurrió una excepción al llamar a <b>{$a->fullmethodname}</b>.<br>Esto significa que el plugin <b>{$a->component}</b>  no terminó de procesar los datos. Debajo puede encontrar la información de la excepción que puede ser pasada al desarrollador del plugin.</p><pre>{$a->message}<br>
...
$string['expiredretentionperiodtask'] = 'Período de retención expirado';
$string['expiredrolewithretention'] = '{$a->retention} (Expirado)';
$string['expiry'] = 'Caducidad';
$string['explanationtitle'] = 'Íconos usados en esta página y lo que significan.';
...
$string['hide'] = 'Colapsar todo';
$string['httpwarning'] = 'Cualquier dato descargado de este sitio podría no estar encriptado. Por favor póngase en contacto  con su administrador del sistema y solicite que instalen SLL en este sitio.';
...
$string['noexpiredcontexts'] = 'Este nivel del contexto no tiene datos para los cuales haya expirado el período de retención.';
...
$string['privacyrequestexpiry_desc'] = 'El tiempo que estarán disponibles solicitudes de datos para descarga antes de expirar. Si se configura a 0, entonces no hay límite de tiempo.';
...
* la hora del último ingreso del usuario es comparada contra el período de retención para usuarios; y
...
$string['roleoverrideoverview'] = 'La política de retención por defecto puede ser anulada para roles específicos de usuarios, permitiéndole a Usted especificar una política de retención más larga o más corta. Un usuario solamente está expirado cuando todos sus roles han expirado.';
...
$string['send'] = 'Enviar';
$string['sensitivedatareasons'] = 'Razones para tratamiento de datos personales sensibles (delicados)';
$string['sensitivedatareasons_help'] = 'Seleccione una o más razones aplicables que eximen de la prohibición de tratamiento de datos personales sensibles (delicados) ligados a este propósito. Para mayor información, por favor vea <a href="https://gdpr-info.eu/art-9-gdpr/" target="_blank">GDPR Art. 9.2</a>';
...
$string['showdataretentionsummary_desc'] = 'Si se habilita, un enlace hacia el resumen de conservación de datos es mostrado en el pie de la página y en el perfil del usuario.';
...
$string['statuspreprocessing'] = 'Pre-procesando';
...
$string['subjectscope_help'] = 'El alcance del asunto enlista los roles que pueden ser asignados en este contexto.';
$string['summary'] = 'Resumen de configuración del registro';
$string['systemconfignotsetwarning'] = 'No se han definido una categoría y un propósito del sitio. Cuando éstas no están definidas, todos los datos serán removidos cuando se procesen las solicitudes de eliminación.';
$string['tobedeleted'] = 'Datos a ser eliminados';
$string['unexpiredrolewithretention'] = '{$a->retention} (No expirado)';
$string['user'] = 'Usuario';
$string['userlistexplanation'] = 'Este plugin tiene el provedor base pero también debería de implementar el userlist provider (provedor de lista_de_usuarios) para soporte completo de funcionalidad de privacidad.';
$string['userlistnoncompliant'] = 'Falta userlist provider (provedor de lista_de_usuarios).';
