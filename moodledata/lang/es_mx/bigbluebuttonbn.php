...
/**
 * Strings for component 'bigbluebuttonbn', language 'es_mx', branch 'MOODLE_39_STABLE'
 *
...
$string['config_meetingevents_enabled_description'] = 'Habilitar el plugin para aceptar y procesar eventos en vivo después de que termine la sesión. (Esta característica es experimental y solamente funciona si el servidor BigBlueButton es capaz de procesar scripts post_events).';
...
$string['mod_form_field_welcome_default'] = '¡<br>Bienvenido a  <b>%%CONFNAME%%</b>!<br><br>Para ayuda sobre el uso de BigBlueButton vea estos cortos <a href="event:http://www.bigbluebutton.org/content/videos"><u>videos tutoriales</u></a>.<br><br>Para unir el puente de audio elija el ícono del teléfono (esquina superior central). <b>Por favor use audífonos para evitar causarles ruidos a los demás.</b>';
$string['mod_form_field_welcome_help'] = 'Remplace el mensaje por defecto puesto por el servidor BigBlueButton. El mensaje puede incluir las siguientes palabras clave (%%CONFNAME%%, %%DIALNUM%%, %%CONFNUM%%) que serán sustituidas automáticamente, y también marcas HTML tales como <b>...</b> o <i></i>';
...
$string['view_groups_nogroups_warning'] = 'La sala fue configurada para usar grupos, pero el curso no tienen grupos definidos.';
