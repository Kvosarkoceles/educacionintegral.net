...
/**
 * Strings for component 'tool_pluginskel', language 'es_mx', branch 'MOODLE_38_STABLE'
 *
...
$string['addmore_message_providers'] = 'Añadir más provedores de mensaje';
...
$string['delete_message_providers'] = 'Eliminar provedor de mensaje';
...
$string['features_upgradelib'] = 'Actualizar librería';
...
$string['message_providers'] = 'Provedores de mensaje';
$string['message_providers_capability'] = 'Capacidad requerida';
$string['message_providers_capability_help'] = 'La capacidad que requiere el usuario para poder recibir el mensaje producido por el provedor.';
$string['message_providers_name'] = 'Nombre';
$string['message_providers_name_help'] = 'El nombre para el provedor del mensaje. El provedor del mensaje está definido en el archivo db/messages.php.';
$string['message_providers_title'] = 'Título';
$string['message_providers_title_help'] = 'Una descripción corta, de una línea, del provedor del mensaje. Representa el valor del texto para la cadena de caracteres de idioma  "messageprovider:name".';
