...
/**
 * Strings for component 'hvp', language 'es_mx', branch 'MOODLE_39_STABLE'
 *
 * @package   hvp
...
$string['addedandupdatedsp'] = 'Se añadió {$a->%new} nueva librería H5P y se actualizaron {$a->%old} antiguas.';
$string['addedandupdatedss'] = 'Se añadió {$a->%new} nueva librería H5P y se actualizó {$a->%old} antigua.';
...
$string['addlibraries'] = 'Añadir librerías';
...
$string['ctcachedescription'] = 'Al asegurar que el caché de tipo de contenido está actualizado, se asegurará de que Usted pueda ver, descargar y usar las librerías más nuevas. Esto es diferente de actualizar a las librerías por ellas mismas.';
...
$string['ctcachesuccess'] = '¡Caché de librería fue actualizado exitosamente!';
...
$string['downloadfailed'] = 'Falló la descarga de librería solicitada.';
...
$string['hubisdisableduploadlibraries'] = 'El Hub H5P ha sido deshabilitado hasta que este problema pueda ser resuelto. Usted todavía puede subir librerías mediante la página de "Librerías H5P".';
...
$string['hvp:installrecommendedh5plibraries'] = 'Instalar nuevos tipos seguros de librerías H5P recomendadas por H5P.org';
...
$string['installedlibraries'] = 'Librerías instaladas';
...
$string['invalidlanguagefile'] = 'Archivo de idioma inválido {$a->%file} en librería {$a->%library}';
$string['invalidlanguagefile2'] = 'Archivo de idioma inválido {$a->%languageFile} ha sido incluido en la librería {$a->%name}';
$string['invalidlibrary'] = 'Librería inválida';
...
$string['invalidsemanticsjson'] = 'El archivo semantics.json inválido ha sido  incluido en la librería {$a->%name}';
...
$string['libraries'] = 'Librerías H5P';
$string['librarydirectoryerror'] = 'El nombre del directorio de la librería debe coincidir con machineName o con machineName-majorVersion.minorVersion (from library.json). (Directorio: {$a->%directoryName} , machineName: {$a->%machineName}, majorVersion: {$a->%majorVersion}, minorVersion: {$a->%minorVersion})';
...
$string['librarylistlibrarydependencies'] = 'Dependencias de Librería';
...
$string['missinglibraryfile'] = 'El archivo "{$a->%file}" falta en la librería: "{$a->%name}"';
$string['missinglibraryjson'] = 'No pudo encontrarse el archivo library.json con un formato json válido para la librería {$a->%name}';
...
$string['privacy:metadata:hvp_events:library_name'] = 'La librería que el evento afectó.';
$string['privacy:metadata:hvp_events:library_version'] = 'La versión de la librería que el evento afectó.';
...
$string['updatedlibraries'] = 'Se actualizaron {$a->%old} librerías H5P.';
$string['updatedlibrary'] = 'Librería H5P {$a->%old} actualizada.';
$string['updatelibraries'] = 'Actualizar Todas las Librerías';
...
$string['upgradeerrordata'] = 'No pudieron cargarse datos para librería %lib.';
$string['upgradeerrormissinglibrary'] = 'Falta librería necesaria %lib.';
...
$string['upgradelibrarycontent'] = 'Actualizar contenido de librería';
$string['upgradelibrarymissing'] = 'Error:¡ Falta su librería!';
...
$string['upgradenoavailableupgrades'] = 'No hay actualiozaciones disponibles para su librería.';
$string['upgradenothingtodo'] = 'No hay instancias de contenido para actualizar.';
$string['upgradereturn'] = 'Regresar';
$string['upload'] = 'Subir';
$string['uploadlibraries'] = 'Subir Librerías';
...
$string['wrongversion'] = 'La versión de la librería H5P {$a->%machineName} usada en este contenido no es válida. El contenido tiene {$a->%contentLibrary}, pero debería ser {$a->%semanticsLibrary}.';
$string['year'] = 'Año';
$string['years'] = 'Año(s)';
