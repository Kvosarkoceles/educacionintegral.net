...
/**
 * Strings for component 'badges', language 'es_mx', branch 'MOODLE_39_STABLE'
 *
 * @package   badges
...
$string['addbadge_help'] = 'Seleccionar todas las insignias que deberían ser añadidas a este requisito para insignia. Presione la tecla CTRL para seleccionar múltiples ítems.';
$string['addcohort'] = 'Añadir cohorte';
$string['addcohort_help'] = 'Seleccionar todas las cohortes que deberían ser añadidas a este requisito para insignia. Mantener presionada la tecla CTRL para seleccionar varios ítems.';
$string['addcompetency'] = 'Añadir competencia';
$string['addcompetency_help'] = 'Seleccionar todas las competencias que deberían de ser añadidas a este requisito para insignia. Mantenga presionada la tecla CTRL para seleccionar varios ítems.';
...
$string['backpackconnectionunexpectedresult'] = 'Hubo un problema al contactar a su Mochila. Por favor, revise las credenciales e inténtelo nuevamente.';
...
$string['backpackimport_help'] = 'Despuès de que se establezca la conexiòn exitosa a mochila, las insignias de su mochila podrán mostrarse en la página de "Mis Insignias" y su página de perfil.

En esta área, Usted puede seleccionar colecciones de insignias desde su mochila que a Usted le gustarìa mostrar en su perfil.';
$string['backpackneedsupdate'] = 'La mochila conectada a este perfil no coincide con la mochila para el sitio. Usted necesita desconectar y reconectar la mochila.';
...
$string['criteria_7_help'] = 'Permite que una insignia sea otorgada a usuarios basada en las otras insignias que han ganado.';
...
$string['error:guestuseraccess'] = 'Usted actualmente está usando acceso de invitado. Para ver insignias Usted necesita ingresar con su cuenta de usuario.';
...
$string['error:nobadges'] = 'No hay insignias de curso o sitio con acceso habilitado para ser añadidas como criterio.';
...
$string['error:nogroups'] = '<p>No hay colecciones públicas de insignias disponibles en su mochila. </p>
<p>Solamente se muestran colecciones públicas, <a href="https://backpack.openbadges.org">Visite su mochila</a> para crear algunas colecciones públicas.</p>';
...
$string['messagebody'] = '<p>¡A Usted le han otorgado la insignia "%badgename%"!</p> <p>Puede encontrar más información acerca de esta insignia en la página de %badgelink%.</p> <p>Usted puede descargar y gestionar la insignia desde su página {$a}.</p>';
...
$string['recipientvalidationproblem'] = 'El usuario actual no puede ser verificado como destinatario para esta insignia.';
...
$string['sitebackpackverify'] = 'Conexión a mochila';
