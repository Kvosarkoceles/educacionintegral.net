...
/**
 * Strings for component 'mumie', language 'es_mx', branch 'MOODLE_39_STABLE'
 *
 * @package   mumie
...
$string['mumie_form_activity_container_help'] = 'Por favor seleccione si la actividad debería abrir en una nueva pestaña del navegador o incrustada dentro de Moodle.';
...
$string['mumie_form_activity_problem_help'] = 'Un problema MUMIE es un solo ejercicio calificado en MUMIE';
