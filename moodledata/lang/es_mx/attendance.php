...
/**
 * Strings for component 'attendance', language 'es_mx', branch 'MOODLE_39_STABLE'
 *
 * @package   attendance
...
$string['error:qrcode'] = '¡El permitirles a los estudiantes que registren su propia asistencia debe estar habilitado para usar el còdigo QR! Saltándolo.';
...
$string['noabsentstatusset'] = 'El estatus configurado en uso no tiene un estatus a usar cuando no está marcado.';
...
$string['warningpercent_help'] = 'Se disparará una advertencia cuando el porcentaje promedio caiga por debajo de este número.';
