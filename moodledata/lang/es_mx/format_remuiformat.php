...
/**
 * Strings for component 'format_remuiformat', language 'es_mx', branch 'MOODLE_39_STABLE'
 *
...
$string['defaultbuttoncolour_desc'] = 'El color del botón de tópico de Vista.';
$string['defaultcardbackgroundcolor'] = 'Configurar el color del fondo de sección en formato tarjeta.';
...
$string['defaultnumberoftopics_desc'] = 'El número de tópicos a ser mostrados en una página';
$string['defaultoverlaycolour'] = 'Color sobrepuesto predeterminado cuando el usuario pasa el ratón encima en actividades';
$string['defaultoverlaycolour_desc'] = 'El color al pasar el ratón encima cuando el usuario pasa el ratón encima en actividades';
$string['defaultremuiteacherdisplay'] = 'Mostrar Imagen del Profesor';
$string['defaultremuiteacherdisplay_desc'] = 'Mostrar Imagen del Profesor en el encabezado del curso.';
$string['defaultsectionsummarymaxlength'] = 'Configurar la longitud máxima del resumen de secciones/actividades.';
$string['defaultsectionsummarymaxlength_desc'] = 'Configurar la longitud máxima del resumen de secciones/actividades mostrado en la tarjeta.';
$string['defaultshowsectiontitlesummary'] = 'Mostrar el resumen del título de sección en opción al pasar el ratón encima';
...
$string['editsectionname'] = 'Editar nombre del tópico';
...
$string['pluginname'] = 'formatos de curso Edwise';
$string['previous'] = 'Anterior';
$string['privacy:metadata'] = 'El plugin de formatos de Curso Edwise no almacena ningún dato personal.';
$string['progress'] = 'Progreso';
$string['remuicourseformat'] = 'Elegir diseño';
...
$string['remuicourseimage'] = 'Elegir una imagen del curso';
$string['remuicourseimage_help'] = 'Elegir una imagen del curso';
...
$string['sectiontitlesummarymaxlength_help'] = 'Configurar la longitud máxima del resumen del título de secciones/actividades mostrado en la tarjeta.';
