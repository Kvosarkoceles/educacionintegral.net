...
/**
 * Strings for component 'grouptool', language 'es_mx', branch 'MOODLE_38_STABLE'
 *
 * @package   grouptool
...
$string['notification:group_recreated'] = 'El grupo <strong>{$a->groupname}</strong> ha sido re-creado debido a que el grouptool <a href="{$a->grouptoolurl}" title="{$a->grouptoolname}"><strong>{$a->grouptoolname}</strong></a> está configurado para re-crear grupos eliminados.';
...
$string['use_queue_help'] = 'Los estudiantes pueden alinearse en lista de espera para los grupos que ya están llenos; solamente puede ser usado si está habilitado el auto-registro y está configurado un límite del tamaño del grupo.';
