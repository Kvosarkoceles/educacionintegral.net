...
/**
 * Strings for component 'error', language 'es_mx', branch 'MOODLE_39_STABLE'
 *
 * @package   error
...
$string['callbackrejectcomment'] = 'Comentar callback (llamada de retorno) rechazó este comentario.';
...
$string['cannotsavefile'] = '¡No se puede guardar el archivo "{$a}"!';
...
$string['cannotsignup'] = 'Usted no puede crear una cuenta nueva porque ya está ingresado como {$a}.';
...
$string['duplicateusername'] = 'Nombre_de_usuario duplicado: registro pasado por alto';
...
$string['guestcantaccessprofiles'] = 'Los invitados no pueden acceder a perfiles de usuario. Ingrese con una cuenta completa de usuario para continuar.';
...
$string['invalidcommentitemid'] = 'ID de ítem de comentario inválido';
...
$string['invalidfieldname'] = '"{$a}" no es un nombre válido de campo';
...
$string['invalidgradeitemid'] = 'ID del ítem de calificación incorrecto';
...
$string['invalidsesskey'] = 'Su sesión muy probablemente ha caducado. Por favor ingrese nuevamente.';
...
$string['invalidusername'] = 'El nombre_de_usuario dado contiene caracteres inválidos';
$string['invalidusernameblank'] = 'El nombre_de_usuario no puede estar vacío';
...
$string['mnetlocal'] = 'Los usuarios MNET remotos no pueden ingresar localmente';
...
$string['mustbeloggedin'] = 'Usted debe haber ingresado al sitio para poder hacer esto';
...
$string['nologinas'] = 'Usted no está autorizado a \'ingresar como\' ese usuario';
...
$string['nopermissiontorate'] = '¡La valuación (rating) de ítems no está permitida!';
...
$string['oauth1requesttoken'] = 'Error de OAuth 1.0. No obtuvimos la ficha (toke)n para acceso - el provedor de servicios podría estar tirado temporalmente.';
...
$string['rpcerror'] = 'Su comunicación con MNET ha fallado. Éste es el mensaje de error para pasarle a su administrador: {$a}';
...
$string['sessiondiskfull'] = 'La partición de sesiones está llena. No es posible ingresar en este momento. Por favor notifique al administrador del servidor.';
$string['sessionerroruser'] = 'Su sesión ha excedido el tiempo límite. Por favor, ingrese de nuevo.';
$string['sessionerroruser2'] = 'Se ha detectado un error del servidor que afecta a su sesión de ingreso. Por favor, ingrese de nuevo o reinicie su navegador.';
...
$string['unknownblockregion'] = 'La región de bloque \'{$a}\' no es reconocida en esta página.';
$string['unknowncontext'] = 'Este es un contexto desconocido.';
$string['unknowncourse'] = 'Curso desconocido llamado "{$a}"';
...
$string['unknownjsinrequirejs'] = 'No se puede encontrar la librería JS: {$a}';
...
$string['usernamelowercase'] = 'El nombre_de_usuario debe estar en minúsculas';
...
$string['usernotdeletedmissing'] = 'Usuario no eliminado: no se encontró el nombre_de_usuario .';
...
$string['usernotrenamedexists'] = 'Usuario no renombrado: el nuevo nombre_de_usuario ya está en uso.';
$string['usernotrenamedmissing'] = 'Usuario no renombrado: no se ha podido encontrar el nombre_de_usuario anterior.';
