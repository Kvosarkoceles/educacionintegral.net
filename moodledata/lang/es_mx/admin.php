...
/**
 * Strings for component 'admin', language 'es_mx', branch 'MOODLE_39_STABLE'
 *
 * @package   admin
...
$string['configrecaptchaprivatekey'] = 'Cadena de caracteres (clave secreta) usada para comunicarse entre su servidor Moodle y el servidor recaptcha.net. Las claves ReCAPTCHA pueden obtenerse de <a target="_blank" href="https://www.google.com/recaptcha">Google reCAPTCHA</a>.';
...
$string['testoutgoingmailconf_errorcommunications'] = 'Moodle no se pudo comunicar con su servidor de correo. Comience revisando su configuración del correo saliente de Moodle.';
...
$string['testoutgoingmailconf_sentmail'] = 'Moodle entregó exitosamente el mensaje de prueba al servidor de correo.<br />De: {$a->fromemail}<br />Para: {$a->toemail}';
...
$string['userfeedbackencouragement'] = '<p>Moodle 3.9 incluye una característica nueva que le da a los usuarios la opción de proporcionar retroalimentación acerca del programa Moodle a Moodle HQ mediante un sitio externo para para encuestas alojado por Moodle HQ. No se envía ninguna información al sitio de encuestas</p>
...
$string['usermanagement'] = 'Gestión de usuario';
