...
/**
 * Strings for component 'theme_boost', language 'es_mx', branch 'MOODLE_39_STABLE'
 *
 * @package   theme_boost
...
$string['backgroundimage_desc'] = 'La imagen a mostrar como un fondo del sitio. La imagen del fondo que Usted suba aquí anulará la imagen del fondo en sus archivos de pre-configuración del tema.';
$string['bootswatch'] = 'Bootswatch';
$string['bootswatch_desc'] = 'Un bootswatch es un conjunto de variables de Bootstrap y CSS para estilizar a Bootstrap';
...
$string['fontsize'] = 'Tamaño del font base del tema';
$string['fontsize_desc'] = 'Ingrese un tamaño del font en %';
