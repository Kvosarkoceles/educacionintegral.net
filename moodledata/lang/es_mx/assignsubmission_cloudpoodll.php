...
/**
 * Strings for component 'assignsubmission_cloudpoodll', language 'es_mx', branch 'MOODLE_39_STABLE'
 *
...
$string['defaultplayertype'] = 'Mostrar transcripción (profesor)';
$string['defaultplayertypedetails'] = 'Use el reproductor de transcripción interactivo o estático si Usted está transcribiendo, o no mostrar transcripción';
$string['defaultplayertypestudent'] = 'Mostrar transcripción (estudiante)';
...
$string['enabletranscode'] = 'Habilitar transcodificación';
$string['enabletranscode_details'] = 'Cloud Poodle puede transcodificar la grabación a mp3/mp4';
$string['enabletranscription'] = 'Habilitar transcripción';
$string['enabletranscription_details'] = 'Cloud Poodll puede transcribir las palabras del estudiante si se necesita';
$string['en-au'] = 'Inglés (AU)';
...
$string['language'] = 'Idioma del Hablante Cloud Poodll';
$string['london'] = 'Londres, U.K.';
$string['no'] = 'no';
$string['noapisecret'] = 'No se ingresó secreto API. Este plugin no funcionará correctamente.';
$string['noapiuser'] = 'No se ingresó usuario API. Este plugin no funcionará correctamente.';
$string['nosubmission'] = 'No se ha enviado nada para esta tarea';
$string['nosubscriptions'] = 'No hay suscripción vigente para este sitio/plugin';
...
$string['playertype'] = 'Mostrar Transcripción Cloud Poodll (profesor)';
$string['playertypedefault'] = 'Sin transcripción';
$string['playertypeinteractivetranscript'] = 'Transcripción interactiva';
$string['playertypestandardtranscript'] = 'Transcripción estática';
$string['playertypestudent'] = 'Mostrar Transcripción Cloud Poodll (estudiante)';
...
$string['recorderdisplayname'] = 'Grabadora';
...
$string['transcriberamazon'] = 'Transcripción normal';
$string['transcribergooglecloud'] = 'Transcripción rápida (audio solamente)';
$string['transcribernone'] = 'Sin transcripción';
