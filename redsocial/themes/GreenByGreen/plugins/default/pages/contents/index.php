...
<div class="row ossn-page-contents">
	...
	<div id="hlc" class="col-md-6 green-home-left-contents">
		...
		<div class="col-xs-6 green-login">
            ...
            <div class="buttons">
				<button id="open_create" type="button" class="btn btn-warning"><?php echo ossn_print('create:account'); ?></button>
            </div>
			<?php
			}
			?>
...
$(document).ready(function() {
	...
	$('html').css('background-color', '#3ba666');
	var widget_heading = $('.widget-heading').html();
	widget_heading = widget_heading + '<span id=\"close_create\" style=\"float:right; font-weight:normal; cursor:pointer\">X</span>';
