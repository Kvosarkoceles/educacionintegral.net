...
$wc = '11';
$mc = '7';
if(!ossn_isLoggedin() || !com_is_active('OssnChat')) {
	$wc = '12';
	$mc = '8';
}

ossn_register_menu_link('a0', ossn_print('timeline'), ossn_group_url($params['group']->guid), 'groupheader');
...
?>
<div class="ossn-group-profile container-fluid">
	<div class="row ossn-group-top-row">

    <div class="col-md-<?php echo $wc;?>">
        ...
        <div class="header-bottom">
 			...
 			<div id='group-header-menu' class="group-header-menu visible-lg">
				<ul>
					<?php echo ossn_plugin_view('menus/green_groupheader', array('menu_width' => 60)); ?>
				</ul>
			</div>
 			<div id='group-header-menu' class="group-header-menu visible-md">
				<ul>
					<?php echo ossn_plugin_view('menus/green_groupheader', array('menu_width' => 40)); ?>
				</ul>
			</div>
 			<div id='group-header-menu' class="group-header-menu visible-sm">
				<ul>
					<?php echo ossn_plugin_view('menus/green_groupheader', array('menu_width' => 25)); ?>
				</ul>
			</div>
 			<div id='green-group-header-menu' class="group-header-menu visible-xs">
				<ul>
					<?php echo ossn_plugin_view('menus/green_groupheader', array('menu_width' => 1)); ?>
				</ul>
			</div>
    ...
    <div class="row ossn-group-bottom-row">
    	<?php
		...
		?>
		<div class="col-md-<?php echo $mc;?> margin-top-10">
