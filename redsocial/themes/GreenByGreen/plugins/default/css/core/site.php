...
.body-background-image {
	background-image: linear-gradient(161deg, #4dac71 54%, #3ba666 50%);
}
...
.topbar {
	background-image: linear-gradient(161deg, #4dac71 54%, #3ba666 50%);	color: #fff;
    height: 48px;
	z-index: 99;
	position: fixed;
	top: 0px;
...
.sidebar-menu-nav ul .sub-menu a:hover,
.sidebar-menu-nav li .sub-menu a:hover {
	background-color: #0d6c31;
	text-decoration: none;
}
...
.ossn-loading:after {
  ...
  margin: 8px;
  border-radius: 50%;
  border: 6px solid #3ba666;
  border-color: #3ba666 transparent #3ba666 transparent;
...
#green-group-header-menu li:first-child {
    border-left: 1px solid #EEE;
}
...
.ossn-chat-tab-titles {
	background-color: #4dac71 !important;
	border-color: #3ba666;
}
...
@media (max-width: 480px) {
   ...
   *****************************/
    ...
    ************************/
	...
	#green-group-header-menu .dropdown {
		margin-top: 9px;
	}
	#green-group-header-menu li > a:hover, #group-header-menu ul li:hover > a {
...
/* workaround for Ossn 5.2 unnecessary high z-index in OssnLikes  - to be removed in 5.3 */
