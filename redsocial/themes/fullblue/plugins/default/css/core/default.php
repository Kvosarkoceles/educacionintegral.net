...
.btn-primary {
    ...
    border-color: #398439;
    box-shadow: 0 0px 0px rgba(255,255,255,0.05), inset 0 0px 0px rgba(255,255,255,0.05), 0 15px 15px rgba(0,0,0,0.3), inset 0 0px 2px rgba(0,0,0,0.3);
}
...
.ossn-layout-module {
    ...
    padding: 10px;
    box-shadow: 0 0 0 rgba(255,255,255,0.05), inset 0 0 0 rgba(255,255,255,0.05), 0 15px 15px rgba(0,0,0,0.3), inset 0 1px 4px rgba(0,0,0,0.3);
}
...
.topbar {
    ...
    position: relative;
    height: 48px;
    box-shadow: 0 0 0 rgba(255,255,255,0.05), inset 0 1px 0 rgba(255,255,255,0.05), 0 15px 15px rgba(0,0,0,0.3), inset 0 0px 0px rgba(0,0,0,0.3);
}
...
.topbar:hover .ossn-icons-topbar-messages:hover,
.topbar:hover .ossn-icons-topbar-notification i:hover {
	color: #85C1E9;
}
...
.ossn-wall-item {
    ...
    padding-bottom: 0px;
    border-radius: 10px;
    box-shadow: 0 0px 0px rgba(255,255,255,0.05), inset 0 0px 0px rgba(255,255,255,0.05), 0 5px 10px rgba(0,0,0,0.3), inset 0 0px 5px rgba(0,0,0,0.3);
}
...
.sidebar {
    ...
    overflow-x: hidden;
    color: #fff;
    box-shadow: 0 0px 0 rgba(255,255,255,0.05), inset 0 -15px 15px rgba(255,255,255,0.05), 0 0 15px rgba(0,0,0,0.3), inset 0 0 15px rgba(0,0,0,0.3);
}
...
.ossn-widget {
    ...
    box-shadow: 0 0px 0px rgba(255,255,255,0.05), inset 0 0px 0px rgba(255,255,255,0.05), 0 15px 15px rgba(0,0,0,0.3), inset 0 0px 15px rgba(0,0,0,0.3);
}
...
.ossn-chat-tab-titles {
    ...
    box-shadow: 0 -15px 15px rgba(255,255,255,0.05), inset 0 28px 0px rgba(255,255,255,0.05), 0 15px 15px rgba(0,0,0,0.3), inset 0 0px 3px rgba(0,0,0,0.3) !important;
}
...
@media only screen and (min-width: 1360px){
	.ossn-chat-windows-long {
        ...
        display: block !important;
        box-shadow: 0 0 0px rgba(255,255,255,0.05), inset 0 -15px 15px rgba(255,255,255,0.05), 0 0px 15px rgba(0,0,0,0.3), inset 0 0 15px rgba(0,0,0,0.3) !important;
    }
...
.ossn-comment-attach-photo .fa-camera:before {
    float: right !important;
...
.post-control-comment comment-post {
	Color: #000 !important;
}
...
.message-box-recieved::before {
    ...
    -moz-transform: rotate( 29deg) skew( -35deg) !important;
    -ms-transform: rotate( 29deg) skew( -35deg) !important;
    -o-transform: rotate( 29deg) skew( -35deg) !important;
...
.message-box-sent {
    ...
    vertical-align: top !important;
    float: left !important;
    margin: 5px 45px 5px 20px !important;
...
.message-box-sent::before {
    ...
    left: 26px !important;
    top: 0px !important;
    transform: rotate( 205deg) skew( -35deg) !important;
    -moz-transform: rotate( 205deg) skew( -35deg) !important;
    -ms-transform: rotate( 205deg) skew( -35deg) !important;
    -o-transform: rotate( 205deg) skew( -35deg) !important;
    -webkit-transform: rotate( 205deg) skew( -35deg) !important;
    width: 20px !important;
    box-shadow: -2px 2px 2px 0 rgba( 178, 178, 178, .4) !important;
}
.message-box-sent {
