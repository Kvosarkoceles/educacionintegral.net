...
.page-title {
    ...
    margin-bottom: 10px;
    border-radius: 100px;
    box-shadow: 0 0px 0px rgba(255,255,255,0.05), inset 0 0px 0px rgba(255,255,255,0.05), 0 10px 10px rgba(0,0,0,0.3), inset 0 2px 10px rgba(0,0,0,0.3);
    text-align: center;
}
.page-botton-notice {
  margin-top:10px;
...
.admin-dashboard-title {
    ...
    box-shadow: 0 0px 0px rgba(255,255,255,0.05), inset 0 0px 0px rgba(255,255,255,0.05), 0 0px 5px rgba(0,0,0,0.3), inset 0 0px 5px rgba(0,0,0,0.3);
}
