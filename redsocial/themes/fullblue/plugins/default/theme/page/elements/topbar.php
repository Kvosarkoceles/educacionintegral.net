			...
			<div class="col-md-2 left-side left">
				...
				<div class="topbar-menu-left">
					<li id="sidebar-toggle" data-toggle='0'>
						<a role="button" data-target="#"> <i class="fa fa-th-list" style="display: block;"></i></a>
					</li>
				</div>
				<?php } ?>
			</div>
			<div class="col-md-7 site-name text-center <?php echo $hide_loggedin;?>">
				<span><a href="<?php echo ossn_site_url();?>"><img src="<?php echo ossn_theme_url(); ?>images/logo11.png"/></a></span>
			</div>
